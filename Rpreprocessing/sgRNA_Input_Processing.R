...
# Input: 20/23/30mer sgRNA or csv file listing multiple sgRNA in the first column
...
# Usage :
# To input a unique sgRNA :
# Rscript sgRNA_Input_Processing.R [20/23/30mer sgRNA] 
#
# To input a csv file of several sgRNAs :
# Rscript sgRNA_Input_Processing.R [.csv file] 
